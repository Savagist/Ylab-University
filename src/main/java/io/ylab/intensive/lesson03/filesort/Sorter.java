...
public class Sorter {
    private static final int BLOCK_SIZE = 1024 * 1024; // Размер блока для сортировки

    public File sortFile(File dataFile) throws IOException {
        String outputFileName = "src" + File.separator + "main" + File.separator + "resources" + File.separator + "sorted.txt";
